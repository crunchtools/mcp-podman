...
Systemd unit management lives in a separate server,
[mcp-systemd-crunchtools](https://github.com/crunchtools/mcp-systemd) — it
replaced the `service_*` tools that were removed in v1.0.0 (RT #1465).
